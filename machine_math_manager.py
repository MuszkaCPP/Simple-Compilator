class MachineMathManager:
    ...
    def carry_out_operation(
        ...
        # value ? variable
            ...
            if operation == "+" or operation == "*":
                self.code_generator.process_math_operation(
                    operation=operation, left_value=right_value, right_value=left_value
                )
            else:
                self.code_generator.process_math_operation(
                    operation=operation, left_value=left_value, right_value=right_value
                )
