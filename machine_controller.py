...
class MachineController():
    ...
    def update_stack_values(self,
                    tab_indexes, last_read_symbols,
                    machine_values, symbols
                    ):
    ...
    def prepare_values_for_machine_task(self,
                    task='', task_value='',
                    loop_type='', iterator_address=-1,
                    left_symbol_address=-1, left_value=-1,
                    right_symbol_address=-1, right_value=-1
                    ):
        left_is_var = False
        right_is_var = False
            ...
            if(left_symbol.is_tab):
                ...
                if(right_is_var):
                    ...
                    if(right_symbol.is_tab):
                        ...
                        if(right_index == -1):
                            right_index_address = self.get_symbol_by_name(self.last_read_symbols.pop()).get_address()
                        ...
                        if(left_index == -1):
                            left_index_address = self.get_symbol_by_name(self.last_read_symbols.pop()).get_address()
    ...
    def pass_task_to_machine(self, 
                    task='', task_value='', loop_type='',
                    iterator_address=-1,
                    left_symbol_address=-1, left_value=-1,
                    left_index_address=-1, left_offset=-1,
                    right_symbol_address=-1, right_index_address=-1,
                    right_value=-1, right_offset=-1,
                    ):
