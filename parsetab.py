...
_lr_productions = [
  ...
  ('commands -> commands command','commands',2,'p_commands','code_parser.py',165),
  ('commands -> command','commands',1,'p_commands','code_parser.py',166),
  ('command -> identifier ASSIGNMENT expression SEMICOLON','command',4,'p_command_all','code_parser.py',168),
  ('command -> IF condition THEN commands ELSE commands ENDIF','command',7,'p_command_all','code_parser.py',169),
  ('command -> IF condition THEN commands ENDIF','command',5,'p_command_all','code_parser.py',170),
  ('command -> WHILE condition DO commands ENDWHILE','command',5,'p_command_all','code_parser.py',171),
  ('command -> REPEAT commands UNTIL condition SEMICOLON','command',5,'p_command_all','code_parser.py',172),
  ('command -> FOR pidentifier FROM value TO value DO commands ENDFOR','command',9,'p_command_all','code_parser.py',173),
  ('command -> FOR pidentifier FROM value DOWNTO value DO commands ENDFOR','command',9,'p_command_all','code_parser.py',174),
  ('command -> READ identifier SEMICOLON','command',3,'p_command_all','code_parser.py',175),
  ('command -> WRITE value SEMICOLON','command',3,'p_command_write','code_parser.py',183),
  ('expression -> value','expression',1,'p_expression','code_parser.py',188),
  ('expression -> value ADD value','expression',3,'p_expression','code_parser.py',189),
  ('expression -> value SUB value','expression',3,'p_expression','code_parser.py',190),
  ('expression -> value MUL value','expression',3,'p_expression','code_parser.py',191),
  ('expression -> value DIV value','expression',3,'p_expression','code_parser.py',192),
  ('expression -> value MOD value','expression',3,'p_expression','code_parser.py',193),
  ('condition -> value EQUALS value','condition',3,'p_condition','code_parser.py',210),
  ('condition -> value NOT_EQUALS value','condition',3,'p_condition','code_parser.py',211),
  ('condition -> value LOWER value','condition',3,'p_condition','code_parser.py',212),
  ('condition -> value GREATER value','condition',3,'p_condition','code_parser.py',213),
  ('condition -> value LEQ value','condition',3,'p_condition','code_parser.py',214),
  ('condition -> value GEQ value','condition',3,'p_condition','code_parser.py',215),
  ('value -> NUM','value',1,'p_value','code_parser.py',218),
  ('value -> identifier','value',1,'p_value','code_parser.py',219),
  ('identifier -> pidentifier','identifier',1,'p_identifier','code_parser.py',223),
  ('identifier -> pidentifier LEFT_BRACKET pidentifier RIGHT_BRACKET','identifier',4,'p_identifier','code_parser.py',224),
  ('identifier -> pidentifier LEFT_BRACKET NUM RIGHT_BRACKET','identifier',4,'p_identifier_tab','code_parser.py',228),
]
