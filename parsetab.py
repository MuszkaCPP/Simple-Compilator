...
_lr_productions = [
  ...
  ('command -> identifier ASSIGNMENT expression SEMICOLON','command',4,'p_command_all','code_parser.py',171),
  ('command -> IF condition THEN commands ELSE commands ENDIF','command',7,'p_command_all','code_parser.py',172),
  ('command -> IF condition THEN commands ENDIF','command',5,'p_command_all','code_parser.py',173),
  ('command -> WHILE condition DO commands ENDWHILE','command',5,'p_command_all','code_parser.py',174),
  ('command -> REPEAT commands UNTIL condition SEMICOLON','command',5,'p_command_all','code_parser.py',175),
  ('command -> FOR pidentifier FROM value TO value DO commands ENDFOR','command',9,'p_command_all','code_parser.py',176),
  ('command -> FOR pidentifier FROM value DOWNTO value DO commands ENDFOR','command',9,'p_command_all','code_parser.py',177),
  ('command -> READ identifier SEMICOLON','command',3,'p_command_all','code_parser.py',178),
  ('command -> WRITE value SEMICOLON','command',3,'p_command_write','code_parser.py',211),
  ('expression -> value','expression',1,'p_expression_val','code_parser.py',225),
  ('expression -> value ADD value','expression',3,'p_expression_math','code_parser.py',229),
  ('expression -> value SUB value','expression',3,'p_expression_math','code_parser.py',230),
  ('expression -> value MUL value','expression',3,'p_expression_math','code_parser.py',231),
  ('expression -> value DIV value','expression',3,'p_expression_math','code_parser.py',232),
  ('expression -> value MOD value','expression',3,'p_expression_math','code_parser.py',233),
  ('condition -> value EQUALS value','condition',3,'p_condition','code_parser.py',253),
  ('condition -> value NOT_EQUALS value','condition',3,'p_condition','code_parser.py',254),
  ('condition -> value LOWER value','condition',3,'p_condition','code_parser.py',255),
  ('condition -> value GREATER value','condition',3,'p_condition','code_parser.py',256),
  ('condition -> value LEQ value','condition',3,'p_condition','code_parser.py',257),
  ('condition -> value GEQ value','condition',3,'p_condition','code_parser.py',258),
  ('value -> NUM','value',1,'p_value','code_parser.py',261),
  ('value -> identifier','value',1,'p_value','code_parser.py',262),
  ('identifier -> pidentifier','identifier',1,'p_identifier','code_parser.py',266),
  ('identifier -> pidentifier LEFT_BRACKET pidentifier RIGHT_BRACKET','identifier',4,'p_identifier','code_parser.py',267),
  ('identifier -> pidentifier LEFT_BRACKET NUM RIGHT_BRACKET','identifier',4,'p_identifier_tab','code_parser.py',271),
]
