...
_lr_productions = [
  ...
  ('program -> DECLARE declarations BEGIN commands END','program',5,'p_program','compiler.py',131),
  ('program -> BEGIN commands END','program',3,'p_program','compiler.py',132),
  ('declarations -> declarations COMMA pidentifier','declarations',3,'p_declarations','compiler.py',135),
  ('declarations -> declarations COMMA pidentifier LEFT_BRACKET NUM COLON NUM RIGHT_BRACKET','declarations',8,'p_declarations','compiler.py',136),
  ('declarations -> pidentifier','declarations',1,'p_declarations','compiler.py',137),
  ('declarations -> pidentifier LEFT_BRACKET NUM COLON NUM RIGHT_BRACKET','declarations',6,'p_declarations','compiler.py',138),
  ('commands -> commands command','commands',2,'p_commands','compiler.py',141),
  ('commands -> command','commands',1,'p_commands','compiler.py',142),
  ('command -> identifier ASSIGNMENT expression SEMICOLON','command',4,'p_command','compiler.py',144),
  ('command -> IF condition THEN commands ELSE commands ENDIF','command',7,'p_command','compiler.py',145),
  ('command -> IF condition THEN commands ENDIF','command',5,'p_command','compiler.py',146),
  ('command -> WHILE condition DO commands ENDWHILE','command',5,'p_command','compiler.py',147),
  ('command -> REPEAT commands UNTIL condition SEMICOLON','command',5,'p_command','compiler.py',148),
  ('command -> FOR pidentifier FROM value TO value DO commands ENDFOR','command',9,'p_command','compiler.py',149),
  ('command -> FOR pidentifier FROM value DOWNTO value DO commands ENDFOR','command',9,'p_command','compiler.py',150),
  ('command -> READ identifier SEMICOLON','command',3,'p_command','compiler.py',151),
  ('command -> WRITE value SEMICOLON','command',3,'p_command','compiler.py',152),
  ('expression -> value','expression',1,'p_expression','compiler.py',157),
  ('expression -> value ADD value','expression',3,'p_expression','compiler.py',158),
  ('expression -> value SUB value','expression',3,'p_expression','compiler.py',159),
  ('expression -> value MUL value','expression',3,'p_expression','compiler.py',160),
  ('expression -> value DIV value','expression',3,'p_expression','compiler.py',161),
  ('expression -> value MOD value','expression',3,'p_expression','compiler.py',162),
  ('condition -> value EQUALS value','condition',3,'p_condition','compiler.py',167),
  ('condition -> value NOT_EQUALS value','condition',3,'p_condition','compiler.py',168),
  ('condition -> value LOWER value','condition',3,'p_condition','compiler.py',169),
  ('condition -> value GREATER value','condition',3,'p_condition','compiler.py',170),
  ('condition -> value LEQ value','condition',3,'p_condition','compiler.py',171),
  ('condition -> value GEQ value','condition',3,'p_condition','compiler.py',172),
  ('value -> NUM','value',1,'p_value','compiler.py',175),
  ('value -> identifier','value',1,'p_value','compiler.py',176),
  ('identifier -> pidentifier','identifier',1,'p_identifier','compiler.py',179),
  ('identifier -> pidentifier LEFT_BRACKET pidentifier RIGHT_BRACKET','identifier',4,'p_identifier','compiler.py',180),
  ('identifier -> pidentifier LEFT_BRACKET NUM RIGHT_BRACKET','identifier',4,'p_identifier','compiler.py',181),
]
