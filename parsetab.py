...
_lr_productions = [
  ...
  ('declarations -> pidentifier','declarations',1,'p_declarations_single_var','code_parser.py',136),
  ('declarations -> pidentifier LEFT_BRACKET NUM COLON NUM RIGHT_BRACKET','declarations',6,'p_declarations_single_tab','code_parser.py',144),
  ('commands -> commands command','commands',2,'p_commands','code_parser.py',155),
  ('commands -> command','commands',1,'p_commands','code_parser.py',156),
  ('command -> identifier ASSIGNMENT expression SEMICOLON','command',4,'p_command','code_parser.py',158),
  ('command -> IF condition THEN commands ELSE commands ENDIF','command',7,'p_command','code_parser.py',159),
  ('command -> IF condition THEN commands ENDIF','command',5,'p_command','code_parser.py',160),
  ('command -> WHILE condition DO commands ENDWHILE','command',5,'p_command','code_parser.py',161),
  ('command -> REPEAT commands UNTIL condition SEMICOLON','command',5,'p_command','code_parser.py',162),
  ('command -> FOR pidentifier FROM value TO value DO commands ENDFOR','command',9,'p_command','code_parser.py',163),
  ('command -> FOR pidentifier FROM value DOWNTO value DO commands ENDFOR','command',9,'p_command','code_parser.py',164),
  ('command -> READ identifier SEMICOLON','command',3,'p_command','code_parser.py',165),
  ('command -> WRITE value SEMICOLON','command',3,'p_command','code_parser.py',166),
  ('expression -> value','expression',1,'p_expression','code_parser.py',173),
  ('expression -> value ADD value','expression',3,'p_expression','code_parser.py',174),
  ('expression -> value SUB value','expression',3,'p_expression','code_parser.py',175),
  ('expression -> value MUL value','expression',3,'p_expression','code_parser.py',176),
  ('expression -> value DIV value','expression',3,'p_expression','code_parser.py',177),
  ('expression -> value MOD value','expression',3,'p_expression','code_parser.py',178),
  ('condition -> value EQUALS value','condition',3,'p_condition','code_parser.py',182),
  ('condition -> value NOT_EQUALS value','condition',3,'p_condition','code_parser.py',183),
  ('condition -> value LOWER value','condition',3,'p_condition','code_parser.py',184),
  ('condition -> value GREATER value','condition',3,'p_condition','code_parser.py',185),
  ('condition -> value LEQ value','condition',3,'p_condition','code_parser.py',186),
  ('condition -> value GEQ value','condition',3,'p_condition','code_parser.py',187),
  ('value -> NUM','value',1,'p_value','code_parser.py',190),
  ('value -> identifier','value',1,'p_value','code_parser.py',191),
  ('identifier -> pidentifier','identifier',1,'p_identifier','code_parser.py',195),
  ('identifier -> pidentifier LEFT_BRACKET pidentifier RIGHT_BRACKET','identifier',4,'p_identifier','code_parser.py',196),
  ('identifier -> pidentifier LEFT_BRACKET NUM RIGHT_BRACKET','identifier',4,'p_identifier','code_parser.py',197),
]
