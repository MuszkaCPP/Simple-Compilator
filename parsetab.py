...
_lr_productions = [
  ...
  ('command -> identifier ASSIGNMENT expression SEMICOLON','command',4,'p_command_assignment','code_parser.py',178),
  ('command -> IF condition THEN commands ELSE commands ENDIF','command',7,'p_command_all','code_parser.py',268),
  ('command -> IF condition THEN commands ENDIF','command',5,'p_command_all','code_parser.py',269),
  ('command -> WHILE condition DO commands ENDWHILE','command',5,'p_command_all','code_parser.py',270),
  ('command -> REPEAT commands UNTIL condition SEMICOLON','command',5,'p_command_all','code_parser.py',271),
  ('command -> FOR pidentifier FROM value TO value DO commands ENDFOR','command',9,'p_command_all','code_parser.py',272),
  ('command -> FOR pidentifier FROM value DOWNTO value DO commands ENDFOR','command',9,'p_command_all','code_parser.py',273),
  ('command -> WRITE value SEMICOLON','command',3,'p_command_write','code_parser.py',276),
  ('expression -> value','expression',1,'p_expression_val','code_parser.py',291),
  ('expression -> value ADD value','expression',3,'p_expression_math','code_parser.py',295),
  ('expression -> value SUB value','expression',3,'p_expression_math','code_parser.py',296),
  ('expression -> value MUL value','expression',3,'p_expression_math','code_parser.py',297),
  ('expression -> value DIV value','expression',3,'p_expression_math','code_parser.py',298),
  ('expression -> value MOD value','expression',3,'p_expression_math','code_parser.py',299),
  ('condition -> value EQUALS value','condition',3,'p_condition','code_parser.py',359),
  ('condition -> value NOT_EQUALS value','condition',3,'p_condition','code_parser.py',360),
  ('condition -> value LOWER value','condition',3,'p_condition','code_parser.py',361),
  ('condition -> value GREATER value','condition',3,'p_condition','code_parser.py',362),
  ('condition -> value LEQ value','condition',3,'p_condition','code_parser.py',363),
  ('condition -> value GEQ value','condition',3,'p_condition','code_parser.py',364),
  ('value -> NUM','value',1,'p_value_num','code_parser.py',367),
  ('value -> identifier','value',1,'p_value_identifier','code_parser.py',371),
  ('identifier -> pidentifier','identifier',1,'p_identifier','code_parser.py',375),
  ('identifier -> pidentifier LEFT_BRACKET pidentifier RIGHT_BRACKET','identifier',4,'p_identifier','code_parser.py',376),
  ('identifier -> pidentifier LEFT_BRACKET NUM RIGHT_BRACKET','identifier',4,'p_identifier_tab','code_parser.py',387),
]
